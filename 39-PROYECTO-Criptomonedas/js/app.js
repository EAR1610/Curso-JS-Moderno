...
function constultarAPI( moneda, criptomoneda ) {
...
function mostarCotizacionHTML( { PRICE, HIGHDAY, LOWDAY, CHANGEPCTHOUR, LASTUPDATE } ) {
    ...
    ultimasHoras.innerHTML = `<p>Variación últimas 24 hrs <span>${CHANGEPCTHOUR}%</span>`;
